...
def api_translate():
    ...
    if mode == "encode":
        # Multi-Language Pre-Translation: Detects source language script and converts to English pivot text
        try:
            processed_input = GoogleTranslator(source='auto', target='en').translate(user_input)
        except Exception:
            processed_input = user_input

        encrypted_text = vigenere_encrypt(processed_input, secret_key)
